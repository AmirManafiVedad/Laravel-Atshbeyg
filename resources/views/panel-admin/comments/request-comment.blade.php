...
{{--                @endif--}}
        ...
        @section('content')
            ...
            <h1 class="_Table_admin_h1">لیست کامنت های در حال انتظار</h1>
            ...
            <table class="_Table_admin">
                ...
                @foreach($comments as $comment)
                    <tr>
                        ...
                        <td class="_Table_admin_6_6 _Table_requestcomment_status font18"><p class="_Table_requestcomment_status_false">منتشر نشده</p></td>
