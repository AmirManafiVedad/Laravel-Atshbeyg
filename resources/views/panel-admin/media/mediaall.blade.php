...
@section('statistics')
    ...
    <div class="row">
        ...
        @section('content')
            ...
            <h1 class="_Table_admin_h1">لیست رسانه های سایت</h1>
                    ...
                    <tr>
                        ...
                        @if(!is_null($media->path))
                            <td class="_Table_admin_2_2 _Table_img font18">
                                @if($media->category == 'کاربر ها')
                                    <img src="{{url('/Image/Profileuser/'.$media->path)}}">
                                @elseif($media->category == 'پست ها')
                                    <img src="{{url('/Image/PostImage/'.$media->path)}}">
                                @elseif($media->category == 'دسته بندی')
                                    <img src="{{url('/Image/Categories/'.$media->path)}}">
                                @endif
                            </td>
                        @else
                            <td class="_Table_admin_2_2 _Table_img font18">
